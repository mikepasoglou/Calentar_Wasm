using static Calentar.Client.Pages.Scheduler;
...
namespace Calentar.Client
{
    ...
    public static class AppointmentServiceDEL
    {
        public static IEnumerable<AppointmentDto> GetAppointments(DateTime start, DateTime end)
        {
            return AllAppointments
                .Where(x => x.Start.Date <= end && start <= x.End.Date);
        }

        private static readonly List<AppointmentDto> AllAppointments = new()
        {
